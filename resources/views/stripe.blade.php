            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now Rs.({{ $payProduct->price }})</button>
                            </div>
                        </div>
                          <input type="hidden" name="payprice" value="{{ $payProduct->price }}">
                          <input type="hidden" name="paydesc" value="{{ $payProduct->name }}">
                    </form>
                </div>
            </div>        
        </div>
